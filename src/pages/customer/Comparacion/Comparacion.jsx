        ...
        <div>
            ...
            <div className="choose-phone-cont">
                ...
                <div className="phone1-cont">
                    Elige un telefono :
                    <Dropdown options={list ? list : []}
                        optionLabel="Model"
                        placeholder="Elige telefono"
                        onChange={(e) => { onPhone1Selected(e); }}
                        value={cel1} />
                        <div className="input-search-result-cont">
                    <input name="phone1" placeholder="Busca un modelo de telefono" type="text" onChange={handleOnChange} />
                    {searchedItems1!=null ?   <div className="searchResults-cont">
                ...
                <div className="phone2-cont">
                    ...
                    <Dropdown options={list ? list : []}
                        optionLabel="Model"
                        placeholder="Elige telefono"
                        onChange={(e) => { onPhone2Selected(e); }}
                        value={cel2} />
                        <div className="input-search-result-cont">
                          <input name="phone2" placeholder="Busca un modelo de telefono" type="text" onChange={handleOnChange} />
                          {searchedItems2!=null ?   <div className="searchResults-cont">
            ...
            <div className="container-general">
                ...
                <div>
                    <h6>Información del primer teléfono</h6>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>{cel1?.["Storage capacity"] ? cel1["Storage capacity"] : ""}</td>
                        </tr>
                        <tr>
                            <th>CPU</th>
                ...
                <div>
                    <h6>Información del segundo teléfono</h6>
                    <table>
                        ...
                        <tr>
                            <th>Almacenamiento interno</th>
                            <td>{cel2?.["Storage capacity"] ? cel2["Storage capacity"] : ""}</td>
                        </tr>
                        <tr>
                            <th>CPU</th>
