  ...
  return (
    <div className="productinfo">
      ...
      <div className="productinfo_details">
        <div className="big-img">
          <img
            ...
            src={
              product.images[indexT]
                ? product.images[indexT].url || product.images[indexT].uri
      ...
      <div className="productDetail_info">
        ...
        <p className="productDetail_info_description">{product.description}</p>
        ...
        <div className="productDetail_info_btns">
          <button
            ...
            className="productDetail_info_btns_btn1"
          >
            Agregar al carrito
          </button>
          <button
            className="productDetail_info_btns_btn2"
