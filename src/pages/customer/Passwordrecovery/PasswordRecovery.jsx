...
const PasswordRecovery = () => {
  ...
  const setNewPassowrd = async (e) => {
    ...
    if (passwordIsValid()) {
      ...
      showWarning(
        "warn",
        "La contraseña debe tener 6 caracters y los dos campos deben ser iguales!",
        "",
        2000
      );
    }
  ...
  function passwordIsValid() {
    return resetPassFormRef.current[0].value.length >= 6 &&
      resetPassFormRef.current[0].value === resetPassFormRef.current[1].value
      ? true
      : false;
  }
  ...
  return (
    <div className="passrecovery_main">
      ...
      <div className="password-recover-cont" id="password-recover-cont">
        <form
          ref={senCodeFormRef}
          onSubmit={sendCode}
          className="sendCode-form"
          id="sendCode-form"
        >
          <label
            className="password_recovery_lable"
            id="lable"
            for="chk"
            aria-hidden="true"
          >
          ...
          <input
            ...
            required
          />
          <button id="enviar_code" className="send_code_btn">
            Enviar codigo
          </button>
        </form>
        ...
        <div>
          <form
            ...
            className="validate_code_cont"
            id="validate_code_form"
          >
            <label
              className="password_recovery_lable"
              for="chk"
